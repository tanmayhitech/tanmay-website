...
function initSolarSystem() {
  ...
  container.innerHTML = `
    ...
    <div class="solar-wrapper relative w-full max-w-5xl aspect-square sm:aspect-[4/3] md:aspect-[16/10] min-h-[420px] sm:min-h-[480px] mx-auto flex items-center justify-center overflow-visible py-4 select-none">
      ...
      <div id="solar-viewport" class="relative w-full h-full max-w-[850px] max-h-[500px] min-h-[380px] flex items-center justify-center">
